    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
      ...
      <div id="projlist" class="list-group">
        ...
        <a href="<?= base_url() ?>project/discussion/<?= $data->pro_id ?>" class="list-group-item active">Discussion</a>
    ...
    <div class="col-md-6 col-md-offset-1 text-center" style="margin-top:-340px">
            ...
            <div class="container">
              <div class="row colored">
                <h2>Discussion</h2>
                <h5><a href="<?= base_url() ?>discussion/add/<?= $data->pro_id ?>"><u>Add new discussion</u></a></h5><br/>
                <?php
                foreach ($data2 as $key => $value) {
                  echo '<li><a href="'. base_url() . 'discussion/view/' . $value->disc_id . '">' .$value->disc_subject . "</a></li><br/>";
                }
                ?>
              </div>
            </div>
